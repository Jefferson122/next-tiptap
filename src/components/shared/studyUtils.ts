import { exerciseData, sections, ReadAloud, repeatsentences, describeimage, RetellLecture, Answershortquestion, readings, respondSituations, SummarizeWrittentext, Essay, FillInTheBlanks, MultipleChoiceExercises, ReorderParagraphExercises, FillInTheBlanksDrag, OneChoiceExercises, WritingDictation, BlankOption, BlankOptionDrag, Exercise } from "@/components/shared/dataMenu";
  
 /**
   1. Generador Global de Preguntas
...
/**
   * 2. Lógica de límites de ejercicios
  ...
  /**
   * 3. Lógica de Scoring para texto (Dictado / Escritura)
  ...
  /**
   * 4. Configurador de Plan de Estudio por Días (1-8)
   */
